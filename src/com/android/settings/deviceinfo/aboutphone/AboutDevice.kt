...
class AboutDevice : FrameLayout {
    ...
    init {
        ...
        // ROM Version
        val version = SystemProperties.get("org.flare.version")
        val type = SystemProperties.get("ro.flare.buildtype")
        ...
        findViewById<LinearLayout>(R.id.deviceEdit)?.setOnClickListener {
            ...
            val dialogView: View = View.inflate(context, R.layout.flare_device_name_dialog, null)
